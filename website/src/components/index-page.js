...
export function IndexPage() {
    return (<>
      ...
      <InfoList items={[
            ...
            {
                title: 'Easy To Use',
                description: 'Setup Sofa within a single line of code and start using REST API right away.',
            },
            {
                title: 'Let\'s Work Together',
                description: 'We want to hear from you, our community of fellow engineers, come to be collaborators.',
            },
        ]}/>
    </>);
}
