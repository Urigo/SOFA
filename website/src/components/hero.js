...
export const Hero = () => {
    ...
    return (<div className="-mx-72 lg:mx-0 max-h-[calc(100vh-var(--nextra-navbar-height)*2)] md:max-h-min relative opacity-0" ref={container}>
      <Anchor href="/docs" className={[
